<?php
  ...
  $page = "Products"; require_once('header.php');
...
<div class="container">
  ...
  <h1 class="mt-4 mb-3"><?php echo @$get.' '.$page; ?>
    ...
    <div class="row" id='more'>
      <?php
        ...
        if(isset($get)){
         ...
         ?>
        <div class="col-md-12 mt-4 text-center"><?php echo $ttb . '<br/>'; ?></div>
  ...
  <div class="row">
    <div class="col-md-12" id='remove_row'>
      <button type="button" class="btn btn-outline-info text-center mt-4 mb-4 extended" id="load" data-vid='<?php echo $last_id; ?>' data-get='<?php echo $gcat; ?>'>
